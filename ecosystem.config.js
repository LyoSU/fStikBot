module.exports = {
  apps: [{
    ...
    // bot.js drains in-flight updates + the broadcast worker for up to 35s on
    // SIGTERM (the polling long-poll alone can take 30s). PM2's default
    // kill_timeout is 1600ms — it would SIGKILL the process long before that
    // drain finishes, making the graceful path moot.
    kill_timeout: 40000,
